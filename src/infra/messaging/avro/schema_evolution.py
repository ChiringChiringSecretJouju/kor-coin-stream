...
class SchemaEvolutionManager:
    ...
    def set_compatibility(
        ...
        """
        try:
            self.registry.set_compatibility(subject=subject, level=level.value)
    ...
    def get_compatibility(self, subject: str) -> CompatibilityLevel:
        ...
        """
        try:
            config = self.registry.get_compatibility(subject=subject)
    ...
    def test_compatibility(self, subject: str, schema_str: str) -> bool:
        ...
        try:
            ...
            result = self.registry.test_compatibility(
                subject=subject,
                schema={"schema": schema_str, "schemaType": "AVRO"},
            )
    ...
    def get_schema_versions(self, subject: str) -> list[int]:
        ...
        """
        try:
            versions = self.registry.get_versions(subject=subject)
            return versions
        except Exception as e:
            logger.error(
                "스키마 버전 조회 실패",
