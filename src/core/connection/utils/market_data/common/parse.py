...
from src.core.connection.utils.market_data.common.timestamp import (
    get_regional_datetime,
    get_regional_timestamp_ms,
)
from src.core.connection.utils.symbols.symbol_utils import parse_symbol_pair
...
def preprocess_ticker_message(
    ...
    if projection:
        ...
        filtered_message = {
            field: parsed_message.get(field) for field in projection if field in parsed_message
        }
    else:
